...
export const links = [
 ...
 // { icon: "/images/AWS.webp", label: "AWSCloud", details: "AWS details" },
  ...
  { icon: "/images/MEAN & MERN.png", label: "MEAN", details: "MEAN  details" },
  { icon: "/images/MEAN & MERN.png", label: "MERN", details: "MERN details" },
  { icon: "/images/Azure.png", label: "Azure", details: "Azure details" },
  { icon: "/images/Cloud%20Computing.png", label: "Cloud_Computing", details: "Cloud Computing details" },
