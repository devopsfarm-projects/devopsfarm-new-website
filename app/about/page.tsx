      ...
      <img
        ...
        <div className="text-center mt-4">
          ...
          <div className="flex space-x-3 opacity-50 hover:opacity-100 transition-opacity duration-300">
            <a href={social.linkedin}  target="_blank" className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-indigo-50">
            <IconBrandLinkedin  />
            </a>
            <a href={social.twitter}  target="_blank" className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-blue-50">
              <IconBrandX />
            </a>
            <a href={social.instagram}  target="_blank" className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-orange-50">
              <IconBrandInstagram/>
            </a>
          </div>
        </div>
        ...
        {Sections.map((section, index) => (
            <div key={index} className="sticky top-0 h-screen flex items-center justify-center text-white bg-black">
                <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6 px-4 py-20">
                    {section.imageFirst && <img className="object-cover h-96 " src={section.imgSrc} alt={section.alt} />}
