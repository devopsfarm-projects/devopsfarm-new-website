...
import { Trainings, MasterClass, Internship, Consultancy } from '../../public/servicesData';
import Image from "next/image";

// Define the expected type for course data
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (message) {
        switch (message) {
        case 'Trainings':
            courseData = Trainings.map(training => ({
                ...training,
                role: "",
                testimonial: ""
            }));
            break;
        case 'MasterClass':
            courseData = MasterClass.map(course => ({
                ...course,
                role: "",
                testimonial: ""
            }));
          ...
          case 'Internship':
            ...
            break;
        case 'Consultancy':
            courseData = Consultancy.map(course => ({
                ...course,
                role: "",
                testimonial: ""
            }));
